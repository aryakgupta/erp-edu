...
forget an event, fully synchronized with the ERP <a href="https://www.erp.com/page/crm">Open Source CRM</a>.
...
You can ask to have a alarm of type 'notification' in your ERP.  You will have
a notification in you ERP which ever the page you are.

Google Calendar
---------------

With the plugin Google\_calendar, you can synchronize your ERP calendar with Google Calendar.
