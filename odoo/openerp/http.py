...
class WebRequest(object):
    """ Parent class for all ERP Web request types, mostly deals with
...
def route(route=None, **kw):
    ...
    .. admonition:: CSRF Protection
        ...
        ERP implements token-based `CSRF protection
        ...
        * if the endpoint can be called by external parties (not from
          ERP) as e.g. it is a REST API or a `webhook
...
HTTP methods). See
https://www.erp.com/documentation/9.0/reference/http.html#csrf for
more details.
