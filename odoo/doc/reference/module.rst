...
The manifest file serves to declare a python package as an ERP module
...
``category`` (``str``, default: ``Uncategorized``)
    classification category within ERP, rough business domain for the module.
...
``depends`` (``list(str)``)
    ERP modules which must be loaded before this one, either because this
