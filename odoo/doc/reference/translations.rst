...
automatically loaded by ERP when the corresponding language is installed (via
...
ERP automatically exports translatable strings from "data"-type content:
...
code, ERP cannot automatically export translatable terms so they
