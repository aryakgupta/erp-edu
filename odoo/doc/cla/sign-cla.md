...
In order for your contribution to ERP to be accepted, you have to sign the
ERP Contributor License Agreement (CLA). More information about this
...
3. An ERP R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    ...
    If the name of the company is ERP, the file would be
    `doc/cla/corporate/odoo.md`. The file should contain:

    ```
<country>, <date>

<company-name> agrees to the terms of the ERP Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `erp.com`.  In that case someone from the ERP team will
make the pull request on your behalf.

* Printable ERP CCLA v1.0 https://www.erp.com/files/legal/ERP-CCLA-v1.0.pdf
* Printable ERP ICLA v1.0 https://www.erp.com/files/legal/ERP-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for ERP is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the ERP project

* protect the ERP project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the ERP project and its users from bad actors who would contribute
...
contributor really intended to contribute to the ERP project under specific
...
The ERP CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, ERP S.A. to use, modify and
...
(ICLA) of ERP.  The agreement is executed by adding your name and
